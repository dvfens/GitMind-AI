...
const placeholderLanguages = ["TypeScript", "JavaScript", "Markdown"];
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">
            {active
              ? "This card is wired for Phase 2 GitHub data. For now it confirms the selected repository and reserves space for description, stars, and languages."
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-200">
            {active
              ? "Repository summary will appear here after GitHub API integration."
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          ...
          <p className="mt-2 text-sm text-slate-400">
            GitHub popularity metrics slot
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {(active ? placeholderLanguages : ["Awaiting data"]).map((language) => (
              <span
                key={language}
