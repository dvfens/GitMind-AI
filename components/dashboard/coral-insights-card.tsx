  ...
  return (
    <article className="glass-panel fade-in-delay rounded-[28px] p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm text-sky-200/70">Coral Insights</p>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          <p className="text-sm text-slate-400">Open pull requests</p>
          <p className="mt-3 text-3xl font-semibold text-white">
      ...
      <div className="mt-6 grid gap-4">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          <p className="font-medium text-white">Top open issues</p>
          <div className="mt-3 space-y-3">
            {(insights?.topOpenIssues ?? []).slice(0, 3).map((issue) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-start justify-between gap-3 rounded-2xl border border-white/10 px-3 py-3 text-sm text-slate-300 transition hover:border-white/20 hover:text-white"
              >
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4">
          <p className="font-medium text-white">Top open pull requests</p>
          <div className="mt-3 space-y-3">
